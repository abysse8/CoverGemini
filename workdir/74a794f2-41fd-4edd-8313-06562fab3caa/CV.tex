...
\section*{Objectif}
Intégrer un stage d'ingénieur systèmes embarqués et IA appliquée pour contribuer au développement et à l'automatisation de solutions embarquées.
...
\begin{itemize}[leftmargin=*]
    \item Développer des applications en Python et C/C++
    \item Intégrer et traiter les données issues de capteurs et systèmes embarqués
    \item Réaliser l'automatisation et la documentation technique des projets
\end{itemize}
...
\vspace{0.1cm}
\section*{Compétences}
\textbf{Langages} : Python, C++, C, VHDL, Matlab, Bash \\
\textbf{Systèmes embarqués} : ESP32, Raspberry Pi, STM32, FPGA, I2C, SPI, UART, Embedded Linux \\
\textbf{Outils} : Git, MQTT, Oscilloscope, PSPICE, ALTIUM, Cadence, Kicad
\vspace{0.2cm}
