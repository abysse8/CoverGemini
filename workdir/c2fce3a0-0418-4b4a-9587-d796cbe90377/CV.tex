...
\section*{Objectif}
Contribuer au développement de systèmes embarqués fiables et documentés.
...
\begin{itemize}[leftmargin=*]
    \item Développer des outils Python pour l automatisation
    \item Intégrer des capteurs avec MQTT
    \item Documenter les choix techniques
\end{itemize}
...
\vspace{0.1cm}
\section*{Compétences}
\textbf{Langages} : Python, C, C++ \\
\textbf{Systèmes embarqués} : Raspberry Pi, ESP32, MQTT \\
\textbf{Outils} : Git, Flask, SQLite
\vspace{0.2cm}
